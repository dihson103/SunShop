...
import com.dinhson.sunshop.email.EmailSender;
...
public class RegistrationService {
    ...
    public void registry(UserSecurityDTO userDTO){
    ...
    public void confirmUser(String token) {
        ...
        userService.setEnable(confirmToken.getUser());
